...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $renderNavigation(opt_data, opt_ignored, opt_ijData) {
      ie_open('nav', null, null, 'class', 'collapse-basic-search navbar navbar-default navbar-no-collapse');
      ie_open('ul', null, null, 'class', 'nav navbar-nav');
      ie_open('li');
      ie_open('a', null, null, 'class', 'control-menu-icon', 'data-content', 'body', 'data-toggle', 'sidenav', 'data-type', 'fixed-push', 'href', '#metalSidenav');
      ie_void('span', null, null, 'class', 'icon-align-justify metal-playground-component-selector');
      ie_close('a');
      ie_close('li');
      ie_open('li', null, null, 'class', 'active');
      ...
      if (opt_data.currentComponent != null) {
        ie_open('li');
        ie_open('a', null, null, 'class', 'control-menu-icon', 'data-onclick', opt_data.onSaveCurrentStateClickHandler, 'href', '#');
        ie_void('span', null, null, 'class', 'icon-save metal-playground-save-current-state');
        ie_close('a');
        ie_close('li');
      }
      ie_open('li');
      ie_open('a', null, null, 'class', 'control-menu-icon');
      ie_open('span', null, null, 'class', 'text-main');
    ...
    function $renderSidenav(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'sidenav-fixed sidenav-menu-slider closed', 'id', 'metalSidenav');
      ie_open('div', null, null, 'class', 'sidebar sidebar-inverse sidenav-menu');
      ...
      ie_close('div');
      ie_close('div');
      ie_void('div', null, null, 'class', 'sidebar-footer');
      ie_close('div');
      ie_close('div');
      ie_close('div');
    }
    ...
    function $renderColumns(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_void('div', null, null, 'class', 'metal-playground-editor');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-8');
      ie_open('div', null, null, 'class', 'flex-container metal-playground-live-view');
      ie_open('div', null, null, 'class', 'metal-playground-rendered-component');
  ...
  var MetalPlayground = function (_Component) {
    babelHelpers.inherits(MetalPlayground, _Component);

    function MetalPlayground() {
      babelHelpers.classCallCheck(this, MetalPlayground);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }

    return MetalPlayground;
  }(Component);

  Soy.register(MetalPlayground, templates);
  this.metalNamed.MetalPlayground = this.metalNamed.MetalPlayground || {};
  this.metalNamed.MetalPlayground.MetalPlayground = MetalPlayground;
  this.metalNamed.MetalPlayground.templates = templates;
  this.metal.MetalPlayground = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	var core = this.metal.metal;
	var Component = this.metal.component;
	var cancelDebounce = this.metalNamed.debounce.cancelDebounce;
	var debounce = this.metalNamed.debounce.debounce;
	var dom = this.metal.dom;
	var Soy = this.metal.Soy;
	var templates = this.metal.MetalPlayground;
	...
	var MetalPlayground = function (_Component) {
		...
		MetalPlayground.prototype.rendered = function rendered() {
			this.setupEditor_();
			this.setupTooltips_();
		};

		MetalPlayground.prototype.complementJSON_ = function complementJSON_(A, B) {
		...
		MetalPlayground.prototype.handleSelectedComponentStateChange_ = function handleSelectedComponentStateChange_() {
			if (this.isPlaying) {
				var stateJson = this.complementJSON_(this.currentComponent.getState(), Component.STATE);

				this.updateEditorContentWithStateData_(stateJson);
			}
		};

		MetalPlayground.prototype.onEditorSaveHandler_ = function onEditorSaveHandler_() {
			if (!this.editorIgnoreChange_) {
				if (this.editor_.getValue() !== '' && core.isDefAndNotNull(this.currentComponent)) {
					try {
						var stateJson = this.complementJSON_(JSON.parse(this.editor_.getValue()), Component.STATE);
		...
		MetalPlayground.prototype.onComponentClickHandler = function onComponentClickHandler(event) {
			...
			var index = parseInt(item.getAttribute('data-componentindex'));
		...
		MetalPlayground.prototype.onComponentStateClickHandler = function onComponentStateClickHandler(event) {
			event.preventDefault();

			var item = event.currentTarget;
			var componentIndex = parseInt(item.getAttribute('data-componentindex'));
			var stateIndex = parseInt(item.getAttribute('data-stateindex'));

			this.onComponentClickHandler(event);

			var savedStateJson = this.componentList[componentIndex].savedStates[stateIndex];
			this.currentComponent.setState(savedStateJson);
		};

		MetalPlayground.prototype.onPlayingClickHandler = function onPlayingClickHandler(event) {
			event.preventDefault();
		...
		MetalPlayground.prototype.onSaveCurrentStateClickHandler = function onSaveCurrentStateClickHandler() {
			...
			var saveName = prompt('Please enter a name', 'Saved state 1');
		...
		MetalPlayground.prototype.setComponentList_ = function setComponentList_(value) {
			var componentList = [];

			for (var moduleName in value) {
				if (core.isDefAndNotNull(value[moduleName].NAME) && value[moduleName].prototype instanceof Component && value[moduleName].NAME !== MetalPlayground.NAME) {
		...
		MetalPlayground.prototype.setupEditor_ = function setupEditor_() {
			var prevEditorContent = '{"state": "will be displayed here..."}';
			...
			if (this.editor_) {
				...
				var oldDiv = this.editor_.container;
		...
		MetalPlayground.prototype.setupTooltips_ = function setupTooltips_() {
			new Tooltip({
				delay: [300, 150],
				elementClasses: 'fade',
		...
		MetalPlayground.prototype.updateEditorContentWithStateData_ = function updateEditorContentWithStateData_(stateJson) {
			this.editorIgnoreChange_ = true;

			var prevCursorPos = this.editor_.getCursorPosition();
	...
	this.metal.MetalPlayground = MetalPlayground;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'container timer');
      ie_open('div', null, null, 'class', 'col-md-12');
      ie_open('kbd');
      ie_open('kbd');
      ...
      ie_open('button', null, null, 'class', 'btn btn-default', 'type', 'button', 'data-onclick', 'onStartClick');
      itext('Start');
      ie_close('button');
      ie_open('button', null, null, 'class', 'btn btn-default', 'type', 'button', 'data-onclick', 'onPauseClick');
      itext('Pause');
      ie_close('button');
      ie_open('button', null, null, 'class', 'btn btn-default', 'type', 'button', 'data-onclick', 'onStopClick');
      itext('Stop');
      ie_close('button');
      ie_open('button', null, null, 'class', 'btn btn-default', 'type', 'button', 'data-onclick', 'onLapClick');
      itext('Lap');
      ie_close('button');
      ie_open('button', null, null, 'class', 'btn btn-default', 'type', 'button', 'data-onclick', 'onClearLapClick');
      itext('Clean laps');
      ie_close('button');
      ie_close('div');
      ie_close('div');
  ...
  var DigitalClock = function (_Component) {
    babelHelpers.inherits(DigitalClock, _Component);

    function DigitalClock() {
      babelHelpers.classCallCheck(this, DigitalClock);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.metalNamed.DigitalClock = this.metalNamed.DigitalClock || {};
  this.metalNamed.DigitalClock.DigitalClock = DigitalClock;
  this.metalNamed.DigitalClock.templates = templates;
  this.metal.DigitalClock = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	var core = this.metal.metal;
	var templates = this.metal.DigitalClock;
	var Component = this.metal.component;
	var Soy = this.metal.Soy;
	...
	var DigitalClock = function (_Component) {
		...
		DigitalClock.prototype.disposed = function disposed() {
			clearInterval(this.interval);
		};

		DigitalClock.prototype.onStartClick = function onStartClick() {
			console.log('start');
		...
		DigitalClock.prototype.onPauseClick = function onPauseClick() {
			console.log('pause');
		...
		DigitalClock.prototype.onStopClick = function onStopClick() {
			console.log('stop');
		...
		DigitalClock.prototype.onLapClick = function onLapClick() {
			console.log('lap');

			var time = new Date(this.elapsed);
		...
		DigitalClock.prototype.onClearLapClick = function onClearLapClick() {
		...
		DigitalClock.prototype.resetTimer = function resetTimer() {
			this.hours = 0;
			this.minutes = 0;
			this.seconds = 0;
			this.miliseconds = 0;
		...
		DigitalClock.prototype.intervalFunction = function intervalFunction() {
	...
	this.metal.DigitalClock = DigitalClock;
}).call(this);
'use strict';
...
(function () {
  ...
  */
   ...
   */
		...
		Tabs.prototype.addTab = function addTab(tab, index) {
   ...
   */
		...
		Tabs.prototype.addTabByName = function addTabByName(label, disabled, index) {
   ...
   */
		...
		Tabs.prototype.created = function created() {
			this.lastState_ = {
				tab: this.tab
			};
   ...
   */
		...
		Tabs.prototype.defaultChangeRequestFn_ = function defaultChangeRequestFn_(event) {
			this.setState_(event.state);
		};
   ...
   */
		...
		Tabs.prototype.dispatchRequest_ = function dispatchRequest_(state) {
   ...
   */
		...
		Tabs.prototype.findFirstAvailableIndex_ = function findFirstAvailableIndex_() {
			if (!this.disabled) {
   ...
   */
		...
		Tabs.prototype.onClickItem = function onClickItem(event) {
			var item = event.delegateTarget;
   ...
   */
		...
		Tabs.prototype.removeTab = function removeTab(index) {
   ...
   */
		...
		Tabs.prototype.setState_ = function setState_(state) {
			this.tab = state.tab;
   ...
   */
		...
		Tabs.prototype.setTabDisabled = function setTabDisabled(index, disabled) {
   ...
   */
		...
		Tabs.prototype.toggleTabDisabled = function toggleTabDisabled(index) {
...
(function () {
  var Pagination = this.metal.Pagination;
  var Rating = this.metal.Rating;
  var Tabs = this.metal.Tabs;
}).call(this);
}).call(this);
//# sourceMappingURL=metalPlayground.js.map
